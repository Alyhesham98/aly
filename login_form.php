	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				 <a class="navbar-brand" href="index.php"> Vintage<span>Violet</span></a>
			</div>
				...
				<div class="panel panel-danger">
					...
					<div class="panel-body">
						...
						<form onsubmit="return false" id="login">
							...
							<label for="email" style="color: #ba1761;
    						font-family: monospace;">Password</label>
							<input type="password" class="form-control" name="password" id="password" required/>
							<p><br/></p>
							<a href="#" style="color:#333; list-style:none;">Forgotten Password</a><input type="submit" class="btn btn-success" style="float:right;background-color: #ba1761" Value="Login">
