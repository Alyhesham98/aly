  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navtest">
		      <ul class="nav navbar-nav navbar-right">
		        ...
		        <li ><a href="shop.html">Shoping cart</a></li>
		        <li class="dropdown">
               ...
               <li ><a href="map.html">Find Us<span class="sr-only"></span></a></li>
...
<div class="col-md-12 wow fadeInUp"data-wow-duration="1s" data-wow-offset="300" >
		...
		<div class="form-group">
			<input type="email" class="form-control input-lg"  placeholder="Email" name="">
		</div>

		<div class="form-group">
			<input type="password" class="form-control input-lg" placeholder="password" name="">
		</div>


		<button type="button" class="btn-lg btn-block"> Login</button>
